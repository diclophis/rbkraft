...
#bash run-gen-scad.sh openscad/sphere.scad | bash run-vox-blit.sh 9 0 64 0 glass
#bash run-gen-synth.sh openscad/structure-synth.mlx eisenscript/pyramid.es | bash run-vox-blit.sh 256 0 128 0 sandstone
bash run-gen-text.sh "mavencraft.net" | bash run-vox-blit.sh 1024 0 600 0 dirt
