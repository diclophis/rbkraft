...
#bash run-gen-text.sh "mavencraft.net" | bash run-vox-blit.sh 512 0 128 0 dirt
...
bash run-gen-synth.sh openscad/structure-synth.mlx eisenscript/block-of-buildings.es | bash run-vox-blit.sh 256 0 -512 0 stone

#bash run-gen-scad.sh openscad/sphere.scad | bash run-vox-blit.sh 32 0 32 0 glowstone
