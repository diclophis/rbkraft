...
bash run-gen-text.sh "mavencraft.net" | bash run-vox-blit.sh 1024 2000 48 2000 glowstone
...
bash run-gen-scad.sh openscad/sphere.scad | bash run-vox-blit.sh 72 0 -96 0 air
