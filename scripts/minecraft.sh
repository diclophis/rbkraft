...
JVM_ARGS="-mx${RAM} -Xmx${RAM} -Xms${RAM} -XX:MaxGCPauseMillis=1 -XX:+UseG1GC -XX:ParallelGCThreads=256 -XX:ConcGCThreads=256 -XX:InitiatingHeapOccupancyPercent=99 -XX:+AggressiveOpts"
